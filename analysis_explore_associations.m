...
AUPClm1=fitlm(dfw_c_pla,...
    'z_aucrating_perc_post~z_TT_TU+z_aucrating_perc_pre+z_treat_expect_post+z_taste_intensity_post+z_taste_valence_post',...
...
AUPClm2=fitlm(dfw_c_pla,...
    'z_aucrating_perc_post~treat+z_TT_TU+z_aucrating_perc_pre+z_treat_expect_post+z_taste_intensity_post+z_taste_valence_post',...
    'DummyVarCoding','effects','RobustOpts','fair')
anova(AUPClm2)
