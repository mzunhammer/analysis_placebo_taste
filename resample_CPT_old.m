function [rating_in_s,rating_in_s_full_CPT]=resample_CPT_old(x,t,t_max,sampling_rate,max_len_sample_timepoints)
    ...
    [ydetrend,ty]=resample(xdetrend,t,max_len_sample_timepoints/(t_max*10));
